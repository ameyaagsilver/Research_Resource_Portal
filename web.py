...
class GoogleScraper:
    ...
    # initial_params = {
    #     'q': '',
    #     'sxsrf': 'AOaemvL8ima1UYSeIathAFmAbXpg1Thqww:1642521424496',
    #     'ei': 'UOPmYarOHfWEr7wPg8Ko6Ao',
    #     'ved': '0ahUKEwiqtquQ1bv1AhV1wosBHQMhCq0Q4dUDCA4',
    #     'uact': '5',
    #     'oq': 'arduino',
    #     'gs_lcp': 'Cgdnd3Mtd2l6EAMyBwgAELEDEEMyBwgAELEDEEMyBwgAELEDEEMyBwgAELEDEEMyCAgAEIAEELEDMgcIABCxAxBDMgcIABCxAxBDMgQIABBDMgcIABCxAxBDMgcIABCxAxBDOgcIABBHELADOgcIABCwAxBDOgoIABDkAhCwAxgAOhIILhDHARDRAxDIAxCwAxBDGAE6CwgAEIAEELEDEMkDOgUIABCABEoECEEYAEoECEYYAVCPBFj_DGDeDmgDcAJ4AIABiQGIAb4GkgEDMC43mAEAoAEByAERwAEB2gEGCAAQARgJ2gEGCAEQARgI',
    #     'sclient': 'gws-wiz',
    # }
    pagination_params = {
        'q': 'linux mint',
    ...
    def parse(self, html):
        ...
        print(self.results)
    def write_csv(self):
        '''Writes scraped results to CSV file'''
...
# res = requests.get('https://www.google.com/search?q=arduino')
# soup = bs4.BeautifulSoup(res.text, 'lxml')
# search = soup.select('a')
# print(search)
# print(soup)
...
# linkToOpen = min(50, len(linkElements))
